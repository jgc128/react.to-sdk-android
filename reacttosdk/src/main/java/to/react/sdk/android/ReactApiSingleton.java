...
public class ReactApiSingleton {
    ...
    private ReactApiSingleton(Context context) {
        mCtx = context;
    ...
    public static synchronized ReactApiSingleton getInstance(Context context) {
        if (mInstance == null) {
            mInstance = new ReactApiSingleton(context);
        }
        return mInstance;
    }
